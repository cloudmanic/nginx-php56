...
# Essential php magic
RUN apk add --no-cache php5-curl php5-dom php5-gd php5-ctype php5-zip php5-xml php5-iconv php5-mysql php5-sqlite3 php5-mysqli php5-pgsql php5-json php5-phar php5-openssl php5-pdo php5-mcrypt php5-pdo php5-pdo_pgsql php5-pdo_mysql php5-opcache
